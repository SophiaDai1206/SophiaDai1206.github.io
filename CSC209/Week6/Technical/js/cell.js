...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let clickedCell1 = cells.find(cell => 
        cell.x==160 && cell.y == 160
    );
    let clickedCell2 = cells.find(cell => 
        cell.x==180 && cell.y == 140
    );
    let clickedCell3 = cells.find(cell => 
        cell.x==180 && cell.y == 160
    );
    let clickedCell4 = cells.find(cell => 
        cell.x==200 && cell.y == 160
    );
    let clickedCells = [clickedCell1, clickedCell2, clickedCell3, clickedCell4].filter(cell => cell !== undefined);

    console.log("Selected cells:", clickedCells);

    for (let clickedCell of clickedCells) {
